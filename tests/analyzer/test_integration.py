...
export default App;
""")
        self.create_temp_file("src/index.js", """
import React from 'react';
...
root.render(<App />);
""")
        self.create_temp_file("public/index.html", """
<!DOCTYPE html>
<html>
...
""")
        ...
        lodash_report = next((r for r in dep_analysis.dependency_reports if r.name == "lodash"), None)
    ...
    def test_django_project_full_analysis(self):
        ...
        self.create_temp_file("manage.py", """
#!/usr/bin/env python
import os
import sys
...
""")
        self.create_temp_file("myproject/settings.py", """
...
""")
        self.create_temp_file("myproject/urls.py", """
...
""")
        self.create_temp_file("apps/myapp/models.py", """
...
""")
    ...
    def test_rust_project_full_analysis(self):
        ...
        self.create_temp_file("src/main.rs", """
...
services:
  ...
  db:
    ...
    environment:
      POSTGRES_DB: myapp
""")
        self.create_temp_file(".dockerignore", """
node_modules
.git
""")
    ...
    def test_end_to_end_analysis_workflow(self):
        ...
        assert dep_analysis.health_score < 1.0  # Due to vulnerabilities and deprecated packages
        ...
        license_compat = self.analyzer.check_license_compatibility(dep_analysis.dependency_reports)
    ...
    def test_performance_with_large_project(self):
        ...
        for i in range(10):
            ...
            self.create_temp_file(f"modules/module-{i}/package.json", json.dumps(small_package))
