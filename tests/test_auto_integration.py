...
class TestAutoFeatureIntegration:
    ...
    def test_auto_command_python_project(self, tmp_path, mock_api_responses):
        ...
        with patch("airules.api_clients.AIClientFactory.get_client") as mock_get_client:
            ...
            mock_client = Mock()
            mock_client.generate_completion.return_value = mock_api_responses["generation"]
    ...
    def test_auto_command_with_research_and_validation(self, tmp_path, mock_api_responses):
        ...
        with patch("airules.api_clients.AIClientFactory.get_client") as mock_get_client, \
             patch("airules.api_clients.AIClientFactory.get_research_client") as mock_get_research_client:
            
            # Mock research client
            mock_research_client = Mock()
            mock_research_client.generate_completion.return_value = mock_api_responses["research"]
    ...
    def test_auto_command_with_custom_config(self, tmp_path):
        ...
        with runner.isolated_filesystem(temp_dir=project_path.parent):
            ...
            config_content = config_content.replace("tools = cursor,claude,copilot,cline,roo", "tools = cursor")
