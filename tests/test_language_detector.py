...
"""
        ...
        result = self.detector._detect_language_from_content(python_content, ['Python', 'JavaScript'])
...
"""
        ...
        result = self.detector._detect_language_from_content(js_content, ['Python', 'JavaScript'])
...
"""
        ...
        result = self.detector._detect_language_from_content(ts_content, ['JavaScript', 'TypeScript'])
    ...
    def test_detect_language_from_content_no_match(self):
        ...
        result = self.detector._detect_language_from_content(unclear_content, ['Python', 'JavaScript'])
    ...
    def test_get_primary_language_low_confidence(self):
        ...
        languages = [
            LanguageInfo("Python", 0.05, 1, {".py"}, ".py", ["main.py"]),  # Below 10% threshold
    ...
    def test_get_primary_language_clear_dominance(self):
        ...
        languages = [
            ...
            LanguageInfo("JavaScript", 0.02, 1, {".js"}, ".js", ["script.js"])  # 2% (4x less)
        ]
        
        primary = self.detector.get_primary_language(languages)
        assert primary is not None
        assert primary.name == "Python"  # Should return dominant language even below 10%
    ...
    def test_extension_map_completeness(self):
        ...
        common_extensions = ['.py', '.js', '.ts', '.java', '.go', '.rs', '.rb', '.php', '.cpp', '.c']
        
        for ext in common_extensions:
            assert ext in self.detector.EXTENSION_MAP, f"Extension {ext} not in EXTENSION_MAP"
    ...
    def test_content_patterns_compiled(self):
        ...
        for lang, patterns in self.detector._compiled_patterns.items():
            ...
            for pattern in patterns:
                assert hasattr(pattern, 'findall')  # Compiled regex should have findall method
...
"""
        ...
        self.detector._refine_with_content_analysis(language_counts, language_files, mock_scanner)
