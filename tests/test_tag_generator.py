...
class TestTagGenerator:
    ...
    def test_context_analysis(self):
        ...
        # Test API context
        analysis.frameworks.append(FrameworkInfo(
            name="express",
            category=FrameworkCategory.WEB_FRAMEWORK,
            confidence=0.9
        ))
    ...
    def test_user_preferences_application(self):
        ...
        preferences = {
            'preferred_tags': ['react'],
            'excluded_tags': ['vue']
        }
        
        modified_sources = self.generator._apply_user_preferences(tag_sources, preferences)
        
        # React should be boosted
        react_scores = [score for tag, score in modified_sources['frameworks'] if tag == 'react']
    ...
    def test_data_science_project_detection(self):
        ...
        analysis = AnalysisResult(
            ...
            frameworks=[
                FrameworkInfo(name="pandas", category=FrameworkCategory.ANALYTICS, confidence=0.9),
                FrameworkInfo(name="numpy", category=FrameworkCategory.ANALYTICS, confidence=0.8),
                FrameworkInfo(name="scikit-learn", category=FrameworkCategory.ANALYTICS, confidence=0.8)
            ],
            languages=LanguageInfo(primary_language="python")
        )
...
class TestTagValidator:
    ...
    def test_consolidate_groups(self):
        ...
        if len([tag for tag in tags if tag in ["html", "css", "javascript", "web"]]) >= 3:
    ...
    def test_calculate_tag_relevance_score(self):
        ...
        random_score = self.validator.calculate_tag_relevance_score("random-tag", context)
