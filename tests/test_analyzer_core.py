...
from airules.analyzer.models import AnalysisResult, LanguageInfo, ProjectStructure, FileStats
...
class TestCodebaseAnalyzer:
    ...
    def test_analyze_python_project(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            tests_dir.mkdir()
            (tests_dir / "test_module.py").write_text("def test_function():\n    assert True")
    ...
    def test_analyze_javascript_project(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            assert "Node.js" in result.framework_hints or "npm" in result.framework_hints
    ...
    def test_analyze_multilingual_project(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            assert isinstance(result, AnalysisResult)
            assert len(result.languages) >= 3  # Python, JavaScript, Go (HTML/CSS might be filtered)
    ...
    def test_filter_significant_languages(self):
        ...
        languages = [
            ...
            LanguageInfo("CSS", 0.02, 1, {".css"}, ".css", ["style.css"]),  # Below threshold
        ]
    ...
    def test_get_recommended_tags_limits_count(self):
        ...
        result = AnalysisResult(
            ...
            structure=ProjectStructure(),
            file_stats=FileStats(),
            framework_hints=["Git", "Docker", "Node.js", "Maven", "Gradle", "Webpack", "Babel", "ESLint"]
        )
