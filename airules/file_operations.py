...
class FileManagerProtocol(Protocol):
    ...
    def get_rules_filepath(self, tool: str, lang: str, tag: str, project_path: str) -> Path:
        """Get the file path for rules."""
        ...
    
    def write_rules_file(self, filepath: Path, content: str, dry_run: bool, yes: bool, tool: str) -> None:
